...
const char* ssid = "OPPO F15"; // The name of the WiFi network you want to connect to
const char* password = "12344321"; // The password of the WiFi network

DataParser dataParser; // Create an instance of DataParse

const int udpPort = 11111; // Change this to the desired UDP port
